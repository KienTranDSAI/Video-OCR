...
def merge_boxes(box_dict, is_merge):
        ...
        for j in range(i + 1, len(box_keys)):
            ...
            if is_merge(merged_box, box2):
                ...
                if check_same_line(merged_box['box'], box2['box']):
                    ...
                    merged_box['text_origin'] += " /n " + box2['text_origin']
...
def is_merge(box1, box2, threshold=30.0):
    ...
    with open('/home/kientran/Code/Work/OCR/pipeline/log/log_dist.txt', 'a') as file:
        file.writelines(f"{text1} - {text2}: Vertical dist: {vertical_dist}, Horizontal dist: {horizontal_dist}")
